                    ...
                    <c:forEach items="${cartInfo}" var="ci">
                        <tr>
                            <td class="td_width_1 cart_info_td">
                                ...
                                <%--                            <td class="td_width_2">--%>
                                <%--                                <div class="image_wrap" data-bookid="${ci.imageList[0].productId}" data-path="${ci.imageList[0].uploadPath}" data-uuid="${ci.imageList[0].uuid}" data-filename="${ci.imageList[0].fileName}">--%>
                                <%--                                    <img>--%>
                                <%--                                </div>--%>
                                <%--                            </td>--%>
    ...
    $(".order_btn").on("click", function () {
        ...
        $(".cart_info_td").each(function (index, element) {
            ...
            if ($(element).find(".individual_cart_checkbox").is(":checked") === true) { //체크여부
                ...
                let bookId_input = "<input name='orders[" + orderNumber +
                    "].bookId' type='hidden' value='" + bookId + "'>";
                form_contents += bookId_input;

                let bookCount_input = "<input name='orders[" + orderNumber +
                    "].bookCount' type='hidden' value='" + bookCount + "'>";
